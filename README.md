...
This is a paid coaching service for the game Netrunner. It offers two types of services replay review and coaching session. Replay review can be done either as a turn by turn writeup about a replay you send to me or a video of me going through the replay and analysing it. Coaching sessions are a one on one calls at a time that will work for both of us where the lion's share of it will still be about game replays but we will also talk about deck and matchup theory as well as work on planning ways to improve towards the goals set at the start of the session.
